...
export const validateCreateBooking = [
  ...
  check("specialRequest")
    .exists()
    .withMessage("Special request must exists.")
    .isString()
  ...
  check("checkIn")
    .exists()
    .withMessage("Check in must exists.")
    .notEmpty()
    .withMessage("Check in can't be empty.")
    .custom((value) => {
  ...
  check("checkOut")
    .exists()
    .withMessage("Check out must exists.")
    .notEmpty()
...
export const validateUpdateBooking = [
  ...
  check("orderDate")
    .exists()
    .withMessage("Order Date must exists.")
    .notEmpty()
    .withMessage("The orderDate date cannot be empty.")
    .custom((value) => {
      if (!moment(value, "MM/DD/YYYY", true).isValid()) {
        throw new Error("The end date is not valid.");
      }
